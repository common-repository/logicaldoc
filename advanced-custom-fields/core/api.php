...
function acf_the_field($field_name, $post_id = false ) {
...
function acf_have_rows($field_name, $post_id = false ) {
...
function acf_reset_rows($hard_reset = false ) {
...
function acf_has_sub_field($field_name, $post_id = false ) {
	
	// vars
	$r = acf_have_rows( $field_name, $post_id );
...
function acf_has_sub_fields($field_name, $post_id = false )
{
	return acf_has_sub_field( $field_name, $post_id );
}
...
function acf_get_sub_field($field_name ) {
...
function acf_the_sub_field($field_name)
{
	$value = acf_get_sub_field($field_name);
...
function acf_get_sub_field_object($child_name )
{
	// no field?
	if( empty($GLOBALS['acf_field']) )
	{
...
function acf_get_row_layout()
{
	// vars
	$value = acf_get_sub_field('acf_fc_layout');
...
function acf_update_field($field_key, $value, $post_id = false )
{
	// filter post_id
	$post_id = apply_filters('acf/get_post_id', $post_id );
...
function acf_delete_field($field_name, $post_id )
{
...
function acf_create_field($field )
{
...
function acf_reset_the_repeater_field()
{
	// do nothing
}
...
function acf_the_repeater_field($field_name, $post_id = false)
{
	return acf_has_sub_field($field_name, $post_id);
}
...
function acf_the_flexible_field($field_name, $post_id = false)
{
	return acf_has_sub_field($field_name, $post_id);
}
